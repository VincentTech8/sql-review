...
### Goal
Replace Djongo ORM with MongoEngine ODM, using latest library versions while minimizing database changes and codebase modifications.
...
- Relationships and foreign keys properly migrated
